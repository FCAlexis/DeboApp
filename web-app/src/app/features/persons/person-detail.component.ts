                ...
                <div class="timeline-item">
                  ...
                  <div class="item-content">
                    <div class="item-main">
                      ...
                      <span class="inst-amount">{{ formatCurrency(inst.amountCents) }}</span>
                    </div>
                    <div class="item-footer">
                      <span class="due-date">Vence: {{ formatDate(inst.dueDate) }}</span>
                      <span class="status-tag" [class.overdue]="isOverdue(inst.dueDate)">
                        {{ isOverdue(inst.dueDate) ? 'Vencida' : 'Pendiente' }}
                      </span>
                    </div>
                  </div>
                </div>
...
export class PersonDetailComponent {
  ...
  getMonthName(date: Date): string {
    return date.toLocaleDateString('es-CO', { month: 'short' }).toUpperCase().substring(0, 3);
  }
